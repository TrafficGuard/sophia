...
export class AgentDetailsComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.http
            .get<{ data: Array<{ id: string; name: string }> }>(`${environment.apiBaseUrl}llms/list`)
            .pipe(
                map((response) => {
    ...
    onSubmitFeedback(): void {
        ...
        this.http
            .post(`${environment.apiBaseUrl}/agent/v1/feedback`, {
    ...
    onResumeHil(): void {
        ...
        this.http
            .post(`${environment.apiBaseUrl}/agent/v1/resume-hil`, {
                agentId: this.agentDetails.agentId,
                executionId: this.agentDetails.executionId,
                feedback,
            })
    ...
    onResumeError(): void {
        ...
        this.http
            .post(`${environment.apiBaseUrl}/agent/v1/resume-error`, {
                agentId: this.agentDetails.agentId,
                executionId: this.agentDetails.executionId,
    ...
    cancelAgent(): void {
        this.http
            .post(`${environment.apiBaseUrl}/agent/v1/cancel`, {
                agentId: this.agentDetails.agentId,
                executionId: this.agentDetails.executionId,
    ...
    saveFunctions(selectedFunctions: string[]): void {
        ...
        this.http
            .post(`${environment.apiBaseUrl}agent/v1/update-functions`, {
                agentId: this.agentDetails.agentId,
    ...
    private resumeCompletedAgent(resumeInstructions: string): void {
        this.isSubmitting = true;
        this.http
            .post(`${environment.apiBaseUrl}/agent/v1/resume-completed`, {
                agentId: this.agentDetails.agentId,
                executionId: this.agentDetails.executionId,
